...
public class QFAttacks
{
    ...
    static long get_index_input(int index, int power_of_two)
    {
    ...
    static public void attack_insertion_failure_bb_multithread(int[] mbits, int fbits, int trials, boolean sameInsertion, int cores)
    { 
        long res[];
                                ...
                                double[] occupancy, int num_queries_min, int trials, int cores)
    {
        ...
        csv_data.add(header);
        write_csv("attack_speed_degradation_wb.csv", csv_data);
        csv_data.clear();
        ...
        for(int i=0; i<mbits.length; i++)
        {
            ...
            csv_data.add(data);
            write_csv("attack_speed_degradation_wb.csv", csv_data, true);
            csv_data.clear();
        }
    }
                                ...
                                double[] occupancy, int num_queries_min, int trials, boolean sameInsertion, int cores)
    {
        ...
        String[] header = {"mbits", "o=80%|c=10%", "o=80%|c=5%", "o=80%|c=1%", "o=80%|c=0%",
                                    ...
                                    "o=20%|c=10%", "o=20%|c=5%", "o=20%|c=1%", "o=20%|c=0%",};
        csv_data.add(header);
        write_csv("attack_speed_degradation_bb.csv", csv_data);
        csv_data.clear();
        ...
        for(int i=0; i<mbits.length; i++)
        {
            ...
            String[] data = row.toArray(new String[0]);
            csv_data.add(data);
            write_csv("attack_speed_degradation_bb.csv", csv_data, true);
            csv_data.clear();
        }
    }
